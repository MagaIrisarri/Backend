...
export class VehicleController {
  ...
  public findAll = async (req: Request, res: Response) => {
    try {
      const vehicleList = await this.vehicleService.findAllVehicle();
  ...
  public findOneById = async (req: Request, res: Response) => {
    try {
      const vehicle = await this.vehicleService.findVehicleById({ id: req.params.id as string});
  ...
  public remove = async (req: Request, res: Response) => {
    try {
      const deleted = await this.vehicleService.deleteVehicle({ id: req.params.id as any });
