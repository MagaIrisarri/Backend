import { ParkingSchema, ParkingIdSchema, } from './ParkingSchema.js';
const parkings = []; //Almacenamiento en memoria
async function add(req, res) {
    ...
    const parking = parkingBody.data; //Objeto validado y tipado
